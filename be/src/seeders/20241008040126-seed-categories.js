...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    },
    {
      ...
      path: "search/q?categoryId=2",
      imageUrl: "https://auto365.vn/uploads/images/service/dan-phim-3m/audit-11-03/cong-dung-cua-phim-cach-nhiet.jpg",
      createdAt: new Date(),
      updatedAt: new Date()
    },
    {
    ...
    {
      name: "Độ đèn ô tô", //10
      description: "search/q?categoryId=10",
      path: "do-den-o-to",
